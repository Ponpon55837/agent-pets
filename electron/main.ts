...
// while serving the Vite renderer. Keep the workaround development-only;
// packaged builds and other platforms retain hardware acceleration.
if (shouldDisableDevHardwareAcceleration(
  process.platform,
  app.isPackaged,
  process.env.VITE_DEV_SERVER_URL,
  process.env.AGENT_PETS_DISABLE_GPU,
)) {
  app.disableHardwareAcceleration()
  console.info('Hardware acceleration disabled by AGENT_PETS_DISABLE_GPU for Windows development')
}
